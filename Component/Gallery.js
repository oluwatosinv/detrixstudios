...
const Gallery = () => {
  const GalleryImgs = [
    ...
    {
      name: 5,
      to: "/Mariam-wedding-photography-lagos",
      text: "Mariam and Adeyemi",
      nickName: "Wedding Photography",
      imgUrl:
        "https://res.cloudinary.com/tosin/image/upload/c_scale,h_1438,w_1974/v1646766330/detrix/DSC01886.jpg",
    },
    {
      name: 6,
      to: "/TeeChi",
